  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 7, padding: '3px 6px', borderRadius: 4, background: highlight ? `${GREEN}10` : 'transparent', border: `0.5px solid ${highlight ? GREEN + '22' : 'transparent'}` }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ fontSize: 6.5, color: '#ffffff60', letterSpacing: '0.1em', textTransform: 'uppercase' }}>{label}</div>
        <div style={{ fontSize: 10.5, fontWeight: 700, color: highlight ? GREEN : '#ffffffdd', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{name}</div>
      </div>
      <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 14, color: highlight ? GREEN : '#ffffffbb', flexShrink: 0 }}>{value}</div>
    </div>
  );
}
...
function MotmMiniCard({ matchup: m, motm, imageCache }) {
  ...
  return (
    <div style={{ flex: 1, background: '#111', border: `0.5px solid ${GREEN}20`, borderRadius: 6, padding: '8px 10px', display: 'flex', flexDirection: 'column', gap: 6, position: 'relative', overflow: 'hidden' }}>
      ...
      {/* score context */}
      <div style={{ fontSize: 8, letterSpacing: '0.04em', lineHeight: 1.3 }}>
        <span style={{ color: '#ffffffcc', fontWeight: 700 }}>{winnerName}</span>
        <span style={{ color: '#ffffff70', margin: '0 4px' }}>{winScore.toFixed(1)}–{loseScore.toFixed(1)}</span>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 4, marginTop: 2 }}>
            ...
            <span style={{ fontSize: 8, color: '#ffffff80', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{motm.team}</span>
          </div>
        </div>
    ...
    <div style={{ width: 540, height: 675, background: BLACK, padding: '16px 22px 14px', display: 'flex', flexDirection: 'column', boxSizing: 'border-box', fontFamily: 'system-ui, -apple-system, sans-serif', gap: 0 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 10 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 8.5, color: '#ffffffaa', letterSpacing: '0.14em', textTransform: 'uppercase', marginTop: 2 }}>{leagueName}</div>
        </div>
      </div>
...
function PlayerRow({ player, imageSrc }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
      ...
      <span style={{ fontSize: 9, color: '#ffffff75', width: 24, flexShrink: 0, fontWeight: 700, letterSpacing: '0.02em' }}>{player.position}</span>
      <span style={{ fontSize: 11, color: '#ffffffdd', flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{player.name}</span>
  ...
  return (
    <div style={{ width: 540, height: 675, background: BLACK, padding: '14px 20px 12px', display: 'flex', flexDirection: 'column', boxSizing: 'border-box', fontFamily: 'system-ui, -apple-system, sans-serif', position: 'relative', gap: 0 }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 2 }}>
        <span style={{ fontSize: 7.5, letterSpacing: '0.28em', color: '#ffffff40', textTransform: 'uppercase' }}>FINAL</span>
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 6 }}>
        ...
        <div style={{ fontSize: 9, color: '#ffffff25', fontWeight: 700, paddingBottom: 18, flexShrink: 0 }}>VS</div>
        <div style={{ flex: 1, textAlign: 'center' }}>
  ...
  return (
    <div style={{ width: 540, height: 675, background: BLACK, padding: '16px 22px 14px', display: 'flex', flexDirection: 'column', boxSizing: 'border-box', fontFamily: 'system-ui, -apple-system, sans-serif', position: 'relative' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 10 }}>
        <img src="/cfn-logo.png" alt="CFN" crossOrigin="anonymous" style={{ height: 40, width: 'auto' }} />
        <div>
          <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 19, color: GREEN, letterSpacing: '0.2em', lineHeight: 1 }}>{title}</div>
          <div style={{ fontSize: 8.5, color: '#ffffffaa', letterSpacing: '0.14em', textTransform: 'uppercase', marginTop: 2 }}>{leagueName} · {subtitle}</div>
        </div>
      </div>
      <div style={{ height: 1, background: `${GREEN}25`, marginBottom: 10 }} />

      {/* Column headers */}
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, paddingBottom: 6, borderBottom: `0.5px solid ${GREEN}20`, marginBottom: 6 }}>
        <div style={{ width: 22, textAlign: 'center', fontSize: 7, letterSpacing: '0.12em', color: '#ffffff50', textTransform: 'uppercase' }}>#</div>
        <div style={{ flex: 1, fontSize: 7, letterSpacing: '0.12em', color: '#ffffff50', textTransform: 'uppercase' }}>Team</div>
        {mode === 'record' ? (
          <>
            <div style={{ width: 34, textAlign: 'center', fontSize: 7, letterSpacing: '0.08em', color: '#ffffff50', textTransform: 'uppercase' }}>W-L</div>
            <div style={{ width: 46, textAlign: 'right', fontSize: 7, letterSpacing: '0.08em', color: '#ffffff50', textTransform: 'uppercase' }}>PF</div>
            <div style={{ width: 46, textAlign: 'right', fontSize: 7, letterSpacing: '0.08em', color: '#ffffff50', textTransform: 'uppercase' }}>PA</div>
          </>
        ) : (
          <>
            <div style={{ width: 50, textAlign: 'right', fontSize: 7, letterSpacing: '0.08em', color: '#ffffff50', textTransform: 'uppercase' }}>Points</div>
            <div style={{ width: 34, textAlign: 'right', fontSize: 7, letterSpacing: '0.08em', color: '#ffffff50', textTransform: 'uppercase' }}>W-L</div>
          </>
        )}
      </div>
        ...
        {rows.map((row, i) => {
          ...
          return (
            <div key={i} style={{
              ...
              background: isFirst ? `${GREEN}12` : i % 2 === 0 ? '#ffffff05' : 'transparent',
              border: `0.5px solid ${isFirst ? GREEN + '30' : 'transparent'}`,
            }}>
              <div style={{ width: 22, textAlign: 'center', fontFamily: "'Bebas Neue', sans-serif", fontSize: 16, color: isFirst ? GREEN : isTop3 ? '#ffffffcc' : '#ffffff55', lineHeight: 1 }}>
                {row.rank || i + 1}
              </div>
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontSize: 12, fontWeight: 700, color: isFirst ? GREEN : '#ffffffee', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{row.name}</div>
                {row.streak && <div style={{ fontSize: 7.5, color: '#ffffff55', marginTop: 1 }}>{row.streak}</div>}
              </div>
              {mode === 'record' ? (
                <>
                  <div style={{ width: 34, textAlign: 'center', fontFamily: "'Bebas Neue', sans-serif", fontSize: 14, color: isFirst ? GREEN : '#ffffffcc' }}>{row.wins}-{row.losses}</div>
                  <div style={{ width: 46, textAlign: 'right', fontFamily: "'Bebas Neue', sans-serif", fontSize: 13, color: '#ffffffbb' }}>{typeof row.pf === 'number' ? row.pf.toFixed(1) : row.pf}</div>
                  <div style={{ width: 46, textAlign: 'right', fontFamily: "'Bebas Neue', sans-serif", fontSize: 13, color: '#ffffff55' }}>{typeof row.pa === 'number' ? row.pa.toFixed(1) : row.pa}</div>
                </>
              ) : (
                <>
                  <div style={{ width: 50, textAlign: 'right', fontFamily: "'Bebas Neue', sans-serif", fontSize: 16, color: isFirst ? GREEN : '#ffffffcc' }}>{typeof row.pf === 'number' ? row.pf.toFixed(1) : row.pf}</div>
                  <div style={{ width: 34, textAlign: 'right', fontFamily: "'Bebas Neue', sans-serif", fontSize: 13, color: '#ffffff55' }}>{row.wins != null ? `${row.wins}-${row.losses}` : (row.record || '—')}</div>
                </>
              )}
            </div>
          );
...
function PowerRankingsCard({ rankingsData, week, leagueName }) {
  ...
  return (
    <div style={{ width: 540, height: 675, background: BLACK, padding: '16px 22px 14px', display: 'flex', flexDirection: 'column', boxSizing: 'border-box', fontFamily: 'system-ui, -apple-system, sans-serif', position: 'relative' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 10 }}>
        <img src="/cfn-logo.png" alt="CFN" crossOrigin="anonymous" style={{ height: 40, width: 'auto' }} />
        <div>
          <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 19, color: GREEN, letterSpacing: '0.2em', lineHeight: 1 }}>POWER RANKINGS</div>
          <div style={{ fontSize: 8.5, color: '#ffffffaa', letterSpacing: '0.14em', textTransform: 'uppercase', marginTop: 2 }}>{leagueName} · Week {week}</div>
        </div>
      </div>
      <div style={{ height: 1, background: `${GREEN}25`, marginBottom: 10 }} />
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 6, flex: 1 }}>
        {rankings.map((row, i) => {
          const isFirst = i === 0;
          const moved = row.prev_rank != null ? row.prev_rank - (row.rank || i + 1) : 0;
          const moveStr = moved > 0 ? `▲${moved}` : moved < 0 ? `▼${Math.abs(moved)}` : '—';
          const moveColor = moved > 0 ? '#4caf50' : moved < 0 ? '#e53935' : '#ffffff40';
          return (
            <div key={i} style={{
              ...
              <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 28, color: isFirst ? GREEN : '#ffffff40', lineHeight: 1, width: 30, textAlign: 'center', flexShrink: 0 }}>
                {row.rank || i + 1}
              </div>
              <div style={{ fontSize: 9, color: moveColor, fontWeight: 700, width: 22, textAlign: 'center', flexShrink: 0 }}>{moveStr}</div>
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontSize: 13, fontWeight: 700, color: isFirst ? GREEN : '#ffffffee', lineHeight: 1.2 }}>{row.name}</div>
                {row.blurb && <div style={{ fontSize: 9, color: '#ffffffaa', marginTop: 3, lineHeight: 1.4, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{row.blurb}</div>}
              </div>
              {row.score != null && (
                <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 20, color: isFirst ? GREEN : '#ffffffbb', flexShrink: 0 }}>{typeof row.score === 'number' ? row.score.toFixed(1) : row.score}</div>
              )}
            </div>
          );
        })}
...
export default function Studio() {
  ...
  useEffect(() => {
    if (!unlocked) return;
    setLoading(true); setData(null); setStandingsData(null); setRankingsData(null);
    setActiveSlide(0); setImageCache({}); setImagesPrefetched(false);
    fetch(`/data/${league.id}/matchups.json`).then(r => r.ok ? r.json() : null).then(d => { setData(d); setLoading(false); }).catch(() => setLoading(false));
    fetch(`/data/${league.id}/standings.json`).then(r => r.ok ? r.json() : null).then(setStandingsData).catch(() => setStandingsData(null));
    fetch(`/data/${league.id}/power-rankings.json`).then(r => r.ok ? r.json() : null).then(setRankingsData).catch(() => setRankingsData(null));
  }, [league, unlocked]);
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      for (let i = 0; i < refs.length; i++) {
        ...
        const sl = slides[i];
        const label = sl?.label?.replace(/[^\w\s-]/g, '').trim().replace(/\s+/g, '-').toLowerCase() || `slide-${i + 1}`;
        zip.file(`${league.id}-week${data.week}-${String(i + 1).padStart(2, '0')}-${label}.png`, blob);
      }
  ...
  const renderSlide = (sl) => {
    if (!sl || !data || !report) return null;
    if (sl.type === 'weekly') return <WeeklyReportCard report={report} week={data.week} leagueName={league.name} imageCache={imageCache} />;
    if (sl.type === 'matchup') return <MatchupCard matchup={data.matchups[sl.index]} week={data.week} leagueName={league.name} imageCache={imageCache} />;
    if (sl.type === 'standings') return <StandingsCard standingsData={standingsData} week={data.week} leagueName={league.name} mode="record" />;
    if (sl.type === 'points_standings') return <StandingsCard standingsData={standingsData} week={data.week} leagueName={league.name} mode="points" />;
    if (sl.type === 'power') return <PowerRankingsCard rankingsData={rankingsData} week={data.week} leagueName={league.name} />;
    return null;
  };
    ...
    <main style={S.main}>
      ...
      <div style={S.layout}>
        <div style={S.sidebar}>
          ...
          <div style={{ marginTop: 'auto', paddingTop: 20 }}>
            ...
            <button onClick={handleExport} disabled={!data || exporting} style={{ ...S.exportBtn, ...(!data || exporting ? S.exportBtnDisabled : {}) }}>
              {exporting ? 'Exporting…' : `↓ Export ${slides.length} slides as ZIP`}
            </button>
          </div>
        </div>
        ...
        <div style={S.previewArea}>
          ...
          {data && report && slides.length > 0 && (
            <>
              <div style={S.previewLabel}>Preview — Slide {activeSlide + 1} of {slides.length}</div>
              ...
              <div style={S.slideNav}>
                ...
                <span style={S.navCount}>{activeSlide + 1} / {slides.length}</span>
                <button onClick={() => setActiveSlide(s => Math.min(slides.length - 1, s + 1))} disabled={activeSlide === slides.length - 1} style={S.navBtn}>Next →</button>
              </div>
            </>
          )}
        </div>
