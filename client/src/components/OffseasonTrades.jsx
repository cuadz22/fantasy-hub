...
const styles = {
  ...
  intro: { fontSize: 12, color: 'var(--text-muted)', fontStyle: 'italic', lineHeight: 1.6 },
  empty: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8, padding: '60px 0', borderTop: '0.5px solid var(--border)' },
  ...
  tradeCard: { border: '0.5px solid var(--border)', borderRadius: 8, overflow: 'hidden' },
  tradeLabel: { fontSize: 10, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--text-muted)', background: 'var(--surface)', padding: '8px 16px', borderBottom: '0.5px solid var(--border)' },
  tradeSides: { display: 'flex', flexDirection: 'column', padding: '16px', gap: 0 },
