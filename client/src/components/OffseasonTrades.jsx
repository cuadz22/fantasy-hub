  ...
  'beaners-husseins': [
    {
      ...
      sides: [
        ...
        },
        {
          ...
          toOwner: 'Giovanny',
          items: ['12th round pick', 'Tello Taylor'],
        },
      ],
    },
    {
  ...
  'rebirth': [
    {
      ...
      sides: [
        ...
        },
        {
          ...
          to: 'Pru',
          toOwner: 'Pru',
          items: ["Tello's 8th round pick", 'Cam Skattebo'],
        },
      ],
    },
    {
      ...
      sides: [
        {
          ...
          to: 'Alexis',
          toOwner: 'Alexis',
          items: ["Vic's 1st round pick", "Vic's 11th round pick"],
        },
        {
          from: 'Alexis',
          fromOwner: 'Alexis',
      ...
      sides: [
        {
          ...
          to: 'Jose',
          toOwner: 'Jose',
          items: ["JJ's 1st round pick", "JJ's 5th round pick"],
        },
        {
          from: 'Jose',
          fromOwner: 'Jose',
          to: 'JJ',
          toOwner: 'JJ',
          items: ["Jose's 2nd round pick", "Jose's 4th round pick"],
        },
      ],
    },
    {
      ...
      sides: [
        {
          ...
          to: 'Jose',
          toOwner: 'Jose',
          items: ["Ed's 4th round pick", "Ed's 10th round pick"],
        },
        {
          from: 'Jose',
          fromOwner: 'Jose',
          to: 'Ed',
          toOwner: 'Ed',
          items: ["Jose's 6th round pick", "Jose's 7th round pick"],
        },
      ],
    },
    {
      ...
      sides: [
        ...
        },
        {
          ...
          to: 'Tello',
          toOwner: 'Tello',
          items: ["Pru's 12th round pick", 'Breece Hall'],
        },
      ],
    },
  ],
