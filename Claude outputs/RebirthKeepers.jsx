const KEEPERS = {
  'Alexis': {
    ...
    2026: [
      { player: 'Joe Burrow', round: 4, year: 3 },
      { player: 'Malik Nabers', round: 8, year: 1 },
    ],
  },
  'Oscar': {
    2021: [
    ...
    2026: [
      { player: 'Chase Brown', round: 7, year: 2 },
      { player: 'Jaxson Dart', round: 8, year: 1 },
    ],
  },
  'Cristian': {
    2021: [
    ...
    2026: [
      { player: 'Harold Fannin Jr.', round: 8, year: 1 },
      { player: 'Bhayshul Tuten', round: 10, year: 1 },
    ],
  },
  'Kevin Huertas': {
    2021: [
  ...
  'Hihi': {
    ...
    2026: [
      { player: 'Chris Godwin Jr.', round: 5, year: 1 },
      { player: 'Colston Loveland', round: 8, year: 1 },
    ],
  },
  'Jose': {
    2021: [
    ...
    2026: [
      { player: 'Drake Maye', round: 10, year: 2 },
      { player: "De'Von Achane", round: 10, year: 1 },
    ],
  },
  'Giovanny': {
    2021: [
    ...
    2026: [
      { player: 'Jayden Daniels', round: 2, year: 2 },
      { player: 'Baker Mayfield', round: 7, year: 1 },
    ],
  },
  'Jonathan': {
    2021: [
    ...
    2026: [
      { player: 'Breece Hall', round: 4, year: 1 },
      { player: 'Garrett Wilson', round: 8, year: 2 },
    ],
  },
  'Alex Zarate': {
    2021: [
    ...
    2026: [
      { player: 'Jordan Love', round: 5, year: 3 },
      { player: 'Cam Skattebo', round: 8, year: 1 },
    ],
  },
  'JJ': {
    2021: [
    ...
    2026: [
      { player: 'Puka Nacua', round: 4, year: 1 },
      { player: 'Daniel Jones', round: 14, year: 1 },
    ],
  },
  'Ed': {
    2021: [
    ...
    2026: [
      { player: 'Nico Collins', round: 7, year: 3 },
      { player: 'Rashee Rice', round: 7, year: 1 },
    ],
  },
  'Big Vic': {
    2025: [
    ...
    2026: [
      { player: 'Brock Bowers', round: 8, year: 2 },
      { player: 'Blake Corum', round: 15, year: 1 },
    ],
  },
  'julio': {
    2026: [
      { player: 'Bo Nix', round: 10, year: 2 },
      { player: 'Quinshon Judkins', round: 13, year: 1 },
    ],
  },
};
...
const OWNER_ORDER = [
  'Alexis', 'Oscar', 'Cristian', 'julio', 'Hihi',
